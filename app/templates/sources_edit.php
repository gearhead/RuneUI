<div id="sources-edit-container" class="container">
    ...
    <form class="form-horizontal" action="/sources/" method="post" role="form" data-parsley-validate>
        <fieldset>
            <legend><?=$title?> <span class="<?php if($action == 'add'): ?>hide<?php endif ?>">(<a href="#source-delete-modal" data-toggle="modal">remove this mount</a>)</span></legend>
            <div class="form-group">
                <div class="alert alert-info <?php if(empty($mount['error'])): ?>hide<?php endif ?>">
                    <i class="fa fa-times red sx"></i>
                    <?php if(!empty($mount['error'])): ?> <?=$mount['error'] ?> <?php endif ?>
                </div>
                <label class="col-sm-2 control-label" for="nas-name">Source name</label>
                <div class="col-sm-10">
                    <?php if($action == 'edit'): ?>
                        <input class="form-control osk-trigger input-lg" type="text" id="nas-name" name="mount[name]" value="<?=$mount['name']?>" data-trigger="change" autocomplete="off" placeholder="es: Classical" required>
                        <input type="hidden" name="mount[id]" value="<?=$mount['id']?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php if($action == 'edit'): ?>
                        ...
                        <option value="cifs" <?php if(($mount['type'] == 'cifs') || ($mount['type'] == 'osx')): ?> selected <?php endif ?>>SMB/CIFS</option>
                        <option value="nfs" <?php if($mount['type'] == 'nfs'): ?> selected <?php endif ?>>NFS</option>
                        </select>
                    <?php else: ?>
                        <select id="mount-type" name="mount[type]" class="selectpicker" data-style="btn-default btn-lg">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="nas-ip" name="mount[address]" value="<?php if($action == 'edit'): ?><?=$mount['address']?><?php endif ?>" data-trigger="change" autocomplete="off" placeholder="es: 192.168.1.250" required>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="nas-dir" name="mount[remotedir]" value="<?php if($action == 'edit'): ?><?=$mount['remotedir']?><?php endif ?>" data-trigger="change" autocomplete="off" placeholder="es: Music/Classical">
            ...
            <div id="mount-cifs" class="optional">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="switch-light well" onclick="">
                            <input id="nas-guest" name="nas-guest" type="checkbox" <?php if(empty($mount['username'])): ?> checked="checked" <?php endif ?>>
                ...
                <div id="mount-auth" class="optional disabled">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" id="nas-usr" name="mount[username]" value="<?php if($action == 'edit'): ?><?=$mount['username']?><?php endif ?>" data-trigger="change" autocomplete="off" placeholder="user">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="password" id="nas-pasw" name="mount[password]" value="<?php if($action == 'edit'): ?><?=$mount['password']?><?php endif ?>" autocomplete="off" placeholder="pass">
                    ...
                    <div class="disabler <?php if(!empty($mount['username'])): ?> hide <?php endif ?>"><!-- disabling layer --></div>
                </div>
        ...
        <fieldset id="mount-advanced-config" class="hide">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php if($action == 'edit'): ?>
                        ...
                        <option value="utf8" <?php if($mount['charset'] === 'utf8'): ?> selected <?php endif ?>>UTF8 (default)</option>\n";
                        <option value="iso8859-1" <?php if($mount['charset'] === 'iso8859-1'): ?> selected <?php endif ?>>ISO 8859-1</option>
                        </select>
                    <?php else: ?>
                        <select id="log-level" name="mount[charset]" class="selectpicker" data-style="btn-default btn-lg">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="nas-rsize" name="mount[rsize]" value="<?php if($action == 'edit'): ?><?=$mount['rsize']?><?php endif ?>" data-trigger="change" autocomplete="off" placeholder="8192">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="nas-wsize" name="mount[wsize]" value="<?php if($action == 'edit'): ?><?=$mount['wsize']?><?php endif ?>" data-trigger="change" autocomplete="off" placeholder="16384">
                    <span class="help-block">Change this settings if you experience problems with music playback (e.g., pops or clips)</span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="options" name="mount[options]" value="<?php if($action == 'edit'): ?><?=$mount['options']?><?php endif ?>" data-trigger="change" autocomplete="off">
                    <input type="hidden" name="mount[error]" value="<?=$mount['error']?>">
