<div id="debug-container" class="container debug">
    ...
    <div class="boxed">
        ...
        Please copy and paste the relevant parts it into your posts if you see something which may help.
        See the <a href="https://www.runeaudio.com/forum/raspberry-pi-f7.html" title="RuneAudio Forum" target="forum">forum</a>.<br>
        <i>Note: That data shown below could be old, check the System time in the first section. The data is regenerated when this function starts,
        clicking on <strong>Refresh</strong> will reload the latest data when it becomes available</i></p>
