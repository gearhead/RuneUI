            ...
            <div class="boxed-group">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php else : ?>
                        After switching, <strong><?=$ao ?></strong> input will stop and <strong>MPD</strong> will resume
                        <?php endif; ?>
                        </span>
                    </div>
                    <?php else: ?>
                    <div class="col-sm-10">
                        <span class="help-block"><br>No audio interfaces detected.<br>
                            RuneAudio has automatically set up HTTPd web-streaming service as an audio output. You can listen to this using another device, to tune in use the URL <a href="#" onclick='window.open("http://<?=$hostname ?>.local:8000", "Webstreaming");return false;'>http://<?=$hostname ?>.local:8000</a><br>
                            If you have an audio card installed, you need to select an I&#178;S sound card driver in the <a href="/settings/">Settings Sound output & sound processing menu</a>. RuneAudio may need to be <strong>restarted</strong> to activate the selected card.<br>
    ...
    <form class="form-horizontal" action="" method="post" data-parsley-validate>
        <fieldset>
            ...
            <div class="boxed-group">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select id="mixer-type" name="conf[mixer_type]" class="selectpicker" data-style="btn-default btn-lg">
                            <option value="disabled" <?php if($conf['mixer_type'] == 'disabled'): ?> selected <?php endif ?>>disabled</option>
                            <option value="software" <?php if($conf['mixer_type'] == 'software'): ?> selected <?php endif ?>>enabled - software</option>
                            <option value="hardware" <?php if($conf['mixer_type'] == 'hardware'): ?> selected <?php endif ?>>enabled - hardware</option>
                        </select>
                        ...
                        -->
                        <select id="mixer-type" name="conf[mixer_type]" class="selectpicker" data-style="btn-default btn-lg">
                            <option value="hardware" <?php if($conf['mixer_type'] == 'hardware'): ?> selected <?php endif ?>>enabled</option>
                            <option value="disabled" <?php if($conf['mixer_type'] == 'disabled'): ?> selected <?php endif ?>>disabled</option>
                            <option value="hide" <?php if($conf['mixer_type'] == 'hide'): ?> selected <?php endif ?>>disabled & hide volume knob</option>
                        </select>
                        <span class="help-block">
                            <strong>disabled</strong> - Volume knob disabled. Use this option to achieve the <strong>best audio quality</strong>.<br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control osk-trigger input-lg" type="number" id="start-volume" name="mpdvol[start_volume]" value="<?=$mpd['start_volume'] ?>" data-trigger="change" min="-1" max="100" placeholder="-1" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select id="realtime-volume" name="mpdvol[realtime_volume]" class="selectpicker" data-style="btn-default btn-lg">
                            <option value="yes" <?php if($realtime_volume == '1'): ?> selected <?php endif ?>>realtime</option>
                            <option value="no" <?php if($realtime_volume == '0'): ?> selected <?php endif ?>>on release</option>
                        </select>
        ...
        <fieldset id="general-options">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="text" id="port" name="conf[port]" value="<?=$conf['port'] ?>" data-trigger="change" disabled>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="log-level" name="conf[log_level]" class="selectpicker" data-style="btn-default btn-lg">
                        ...
                        <option value="secure" <?php if($conf['log_level'] == 'secure'): ?> selected <?php endif ?>>secure</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="gapless-mp3-playback" name="conf[gapless_mp3_playback]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="yes" <?php if($conf['gapless_mp3_playback'] == 'yes'): ?> selected <?php endif ?>>enabled</option>
                        <option value="no" <?php if($conf['gapless_mp3_playback'] == 'no'): ?> selected <?php endif ?>>disabled</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <?php if(($hwplatformid === '01') || ($hwplatformid === '08') || ($hwplatformid === '10')): ?>
                <div class="col-sm-10">
                    <select id="dsd-usb" name="conf[dsd_usb]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="DSDNATIVE" <?php if($conf['dsd_usb'] == 'DSDNATIVE'): ?> selected <?php endif ?>>DSD (native)</option>
                        <option value="DSDDOP" <?php if($conf['dsd_usb'] == 'DSDDOP'): ?> selected <?php endif ?>>DSD over PCM</option>
                        <option value="no" <?php if($conf['dsd_usb'] == 'no'): ?> selected <?php endif ?>>default</option>
                    </select>
                ...
                <div class="col-sm-10">
                    <select id="dsd-usb" name="conf[dsd_usb]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="yes" <?php if($conf['dsd_usb'] == 'yes'): ?> selected <?php endif ?>>DSD over PCM</option>
                        <option value="no" <?php if($conf['dsd_usb'] == 'no'): ?> selected <?php endif ?>>default</option>
                    </select>
                    <span class="help-block">Enable special DSD audio support (only effective for USB DAC's)</span>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="replaygain" name="conf[replaygain]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="off" <?php if($conf['replaygain'] == 'off'): ?> selected <?php endif ?>>off</option>
                        <option value="album" <?php if($conf['replaygain'] == 'album'): ?> selected <?php endif ?>>album</option>
                        <option value="track" <?php if($conf['replaygain'] == 'track'): ?> selected <?php endif ?>>track</option>
                        <option value="auto" <?php if($conf['replaygain'] == 'auto'): ?> selected <?php endif ?>>auto</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="volume-normalization" name="conf[volume_normalization]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="yes" <?php if($conf['volume_normalization'] == 'yes'): ?> selected <?php endif ?>>enabled</option>
                        <option value="no" <?php if($conf['volume_normalization'] == 'no'): ?> selected <?php endif ?>>disabled</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="number" id="audio-buffer-size" name="conf[audio_buffer_size]" value="<?=$conf['audio_buffer_size'] ?>" data-trigger="change" min="512" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="buffer-before-play" name="conf[buffer_before_play]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="0%" <?php if($conf['buffer_before_play'] == '0%'): ?> selected <?php endif ?>>disabled</option>\n";
                        <option value="10%" <?php if($conf['buffer_before_play'] == '10%'): ?> selected <?php endif ?>>10%</option>\n";
                        <option value="20%" <?php if($conf['buffer_before_play'] == '20%'): ?> selected <?php endif ?>>20%</option>\n";
                        <option value="30%" <?php if($conf['buffer_before_play'] == '30%'): ?> selected <?php endif ?>>30%</option>\n";
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="auto-update" name="conf[auto_update]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="yes" <?php if($conf['auto_update'] == 'yes'): ?> selected <?php endif ?>>enabled</option>
                        <option value="no" <?php if($conf['auto_update'] == 'no'): ?> selected <?php endif ?>>disabled</option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="webstreaming" name="conf[webstreaming]" class="selectpicker" data-style="btn-default btn-lg">
                        <option value="<?=$samplerate?>" <?php if($conf['webstreaming']): ?> selected <?php endif ?>>enabled</option>
                        <option value="0" <?php if(!$conf['webstreaming']): ?> selected <?php endif ?>>disabled</option>
                    </select>
                    <span class="help-block">This switches streaming of music to your local network on and off.
                    When switched on, tune in with the URL <a href="#" onclick='window.open("http://<?=$hostname ?>.local:8000", "Webstreaming");return false;'>http://<?=$hostname ?>.local:8000</a><br>
    ...
    <form class="form-horizontal" action="" method="post" data-parsley-validate>
        ...
        <fieldset>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control osk-trigger input-lg" type="number" id="crossfade" name="mpd[crossfade]" value="<?=$mpd['crossfade'] ?>" data-trigger="change" min="0" placeholder="0" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="switch-light well" onclick="">
                        <input name="mpd[mpd_autoplay]" type="checkbox" value="1"<?php if((isset($mpd['mpd_autoplay'])) && ($mpd['mpd_autoplay'])): ?> checked="checked" <?php endif ?>>
                        <span><span>OFF</span><span>ON</span></span><a class="btn btn-primary"></a>
                    </label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="switch-light well" onclick="">
                        <input name="mpd[consume]" type="checkbox" value="1"<?php if((isset($mpd['consume'])) && ($mpd['consume'])): ?> checked="checked" <?php endif ?>>
                        <span><span>OFF</span><span>ON</span></span><a class="btn btn-primary"></a>
                    </label>
                    <span class="help-block">When set to ON the entries in the queue are removed after being played</span>
                </div>
            </div>
            <div <?php if($mpd['globalrandom']): ?>class="boxed-group"<?php endif ?> id="grBox">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="globalrandom">Global Random</label>
                    <div class="col-sm-10">
                        <label class="switch-light well" onclick="">
                            <input id="mpd-gr-cb" name="mpd[globalrandom]" type="checkbox" value="1"<?php if((isset($mpd['globalrandom'])) && ($mpd['globalrandom'])): ?> checked="checked" <?php endif ?>>
                            <span><span>OFF</span><span>ON</span></span><a class="btn btn-primary"></a>
                        </label>
                    ...
                    <div id="mpd-gr-fields" class="<?php if($mpd['globalrandom'] != 1): ?>hide<?php endif ?>">
                        <label class="col-sm-2 control-label" for="crossfade">Minimum songs in Queue</label>
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="number" id="minquelen" name="mpd[minquelen]" value="<?=$mpd['minquelen'] ?>" data-trigger="change" min="0" max=10 placeholder="0" />
                        ...
                        <div class="col-sm-10">
                            <label class="switch-light well" onclick="">
                                <input name="mpd[random_album]" type="checkbox" value="1"<?php if((isset($mpd['random_album'])) && ($mpd['random_album'])): ?> checked="checked" <?php endif ?>>
                                <span><span>OFF</span><span>ON</span></span><a class="btn btn-primary"></a>
                            </label>
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" id="exclude" name="mpd[exclude] " value="<?php echo $mpd['exclude']; ?>" autocomplete="off">
                            ...
                            <input class="form-control input-lg" type="text" id="ramdomsource" name="ramdomsource" value="<?php echo $ramdomsource; ?>" disabled autocomplete="off">
            ...
            <div class="form-group form-actions">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg" name="save" value="save">Save and apply</button>
                    <button type="submit" class="btn btn-primary btn-lg <?php if($mpd['globalrandom'] != 1): ?>hide<?php endif ?>" name="resetrp" value="1" id="resetrp">Reset Random Play</button>
                    <?php if($mpd['globalrandom'] != 1): ?>
