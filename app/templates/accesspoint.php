<div id="accesspoint-container" class="container">
    ...
    <?php if($wififullfunction === 0): ?>
        ...
        &nbsp;<br>
    <?php endif ?>
    <div <?php if($enable): ?>class="boxed-group"<?php endif ?> id="accesspointBox">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="switch-light well" onclick="">
                        <input id="accesspoint" name="settings[enable]" type="checkbox" value="1"<?php if((isset($enable)) && ($enable)): ?> checked="checked" <?php endif ?>>
                ...
                <div class="<?php if(!$enable): ?>hide<?php endif ?>" id="accesspointSettings">
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="settings[ssid]">SSID</label>
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" id="ssid" name="settings[ssid]" <?php if (isset($accesspoint['ssid'])): ?>value="<?=$accesspoint['ssid'] ?>" placeholder="Your SSID" data-parsley-trigger="change"<?php else: ?>value="RuneAudioAP" placeholder="Your SSID" data-parsley-trigger="change"<?php endif; ?> required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" id="passphrase" name="settings[passphrase]" <?php if (isset($accesspoint['passphrase'])): ?>value="<?=$accesspoint['passphrase'] ?>" <?php else: ?>value="RuneAudio" <?php endif; ?> placeholder="Passphrase" minlength="8" maxlength="63" pattern="^\S+$" data-parsley-trigger="change" required />
                            <span class="help-block">Set the Password (Passphrase), default is 'RuneAudio'
                            <?php if ((isset($enable)) && ($enable) && isset($accesspoint['passphrase']) && ($accesspoint['passphrase'] == 'RuneAudio')): ?>, <strong>please change it NOW!</strong><?php endif; ?><br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$" id="ip-address" name="settings[ip-address]" <?php if (isset($accesspoint['ip-address'])): ?>value="<?=$accesspoint['ip-address'] ?>" placeholder="192.168.5.1" data-parsley-trigger="change"<?php else: ?>value="192.168.5.1" placeholder="192.168.5.1" data-parsley-trigger="change"<?php endif; ?> required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$" id="broadcast" name="settings[broadcast]" <?php if (isset($accesspoint['broadcast'])): ?>value="<?=$accesspoint['broadcast'] ?>" placeholder="192.168.5.255" data-parsley-trigger="change"<?php else: ?>value="192.168.5.255" placeholder="192.168.5.255" data-parsley-trigger="change"<?php endif; ?> required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" id="dhcp-range" name="settings[dhcp-range]" <?php if (isset($accesspoint['dhcp-range'])): ?>value="<?=$accesspoint['dhcp-range'] ?>" placeholder="192.168.5.2,192.168.5.254,24h" data-parsley-trigger="change"<?php else: ?>value="192.168.5.2,192.168.5.254,24h" placeholder="192.168.5.2,192.168.5.254,24h" data-parsley-trigger="change"<?php endif; ?> required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" id="dhcp-option-dns" name="settings[dhcp-option-dns]" <?php if (isset($accesspoint['dhcp-option-dns'])): ?>value="<?=$accesspoint['dhcp-option-dns'] ?>" placeholder="192.168.5.1" data-parsley-trigger="change"<?php else: ?>value="192.168.5.1" placeholder="192.168.5.1" data-parsley-trigger="change"<?php endif; ?> required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control osk-trigger input-lg" type="text" id="dhcp-option-router" name="settings[dhcp-option-router]" <?php if (isset($accesspoint['dhcp-option-router'])): ?>value="<?=$accesspoint['dhcp-option-router'] ?>" placeholder="192.168.5.1" data-parsley-trigger="change"<?php else: ?>value="192.168.5.1" placeholder="192.168.5.1" data-parsley-trigger="change"<?php endif; ?> required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="switch-light well" onclick="">
                                <input id="enable-NAT" name="settings[enable-NAT]" type="checkbox" value="1"<?php if($accesspoint['enable-NAT']): ?> checked="checked" <?php endif ?><?php if (!isset($accesspoint['passphrase']) || !$accesspoint['passphrase'] || ($accesspoint['passphrase'] == 'RuneAudio')): ?> disabled<?php endif; ?>>
                            ...
                            <span class="help-block">If you would like to share your Ethernet connection over this Wi-Fi Access Point set this to <strong>YES</strong>.<br>
                                <?php if (!isset($accesspoint['passphrase']) || !$accesspoint['passphrase'] || ($accesspoint['passphrase'] == 'RuneAudio')): ?>
    ...
    <fieldset>
        ...
        <div class="boxed">
            <table id="current-settings" class="info-table">
                <tbody>
                    <tr><th>Enabled:</th><td><?php if($accesspoint['enable']): ?>Yes<?php else: ?>No<?php endif; ?></td></tr>
                    <tr><th>IP-Address:</th><td><?=$accesspoint['ip-address'] ?></td></tr>
                    <tr><th>Broadcast:</th><td><?=$accesspoint['broadcast'] ?></td></tr>
                    <tr><th>SSID:</th><td><?=$accesspoint['ssid'] ?></td></tr>
                    <tr><th>Passphrase:</th><td><?=$accesspoint['passphrase'] ?></td></tr>
                    <tr><th>DHCP-Range:</th><td><?=$accesspoint['dhcp-range'] ?></td></tr>
                    <tr><th>DNS server:</th><td><?=$accesspoint['dhcp-option-dns'] ?></td></tr>
                    <tr><th>DNS router:</th><td><?=$accesspoint['dhcp-option-router'] ?></td></tr>
                    <tr><th>Enable-NAT:</th><td><?php if($accesspoint['enable-NAT']): ?>Yes<?php else: ?>No<?php endif; ?></td></tr>
                    <tr><th>Wi-Fi capable:</th><td><?php if($wifiavailable): ?>Yes<?php else: ?>No<?php endif; ?></td></tr>
                    <tr><th>Wi-Fi is AP capable:</th><td><?php if($wififeatureAP): ?>Yes<?php else: ?>No<?php endif; ?></td></tr>
                    <tr><th>AP has full function:</th><td><?php if($wififullfunction): ?>Yes<?php else: ?>No<?php endif; ?></td></tr>
                    <?php if ($accesspoint['ip-address'] === '192.168.5.1'):?>
                        <tr><th>Connect to AP:</th><td><?php if($wififeatureAP): ?><img src="/img/RuneAudioAP.png" style="width: 200px"><?php else: ?><?php endif; ?></td></tr>
                        <tr><th>&nbsp;</td></tr>
                        <tr><th>Connect to RuneAudio:</th><td><?php if($wififeatureAP): ?><img src="/img/RuneAudioURL.png" style="width: 200px"><?php else: ?><?php endif; ?></td></tr>
                    <?php endif;?>
                </tbody>
            </table>
        </div>
