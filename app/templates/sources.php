<div id="sources-container" class="container">
    <h1>Local Sources</h1>
    <p>Your <a href="/#panel-sx">music library</a> is composed by two main content types: <strong>local sources</strong> and <strong>streaming sources</strong>.<br>
    This section lets you configure your <strong>local sources</strong>.</p>
    <legend>Update/Rebuld Library</legend>
    <div class="boxed">
        <p>Instruct <a href="http://www.musicpd.org/" title="Music Player Daemon" rel="nofollow" target="_blank">MPD</a> to Update or Rebuild the library using the contents of <strong>network mounts</strong> and <strong>USB mounts</strong></p>
