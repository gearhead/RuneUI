    ...
    switch ($_GET['cmd']) {
        ...
        case 'MRmute':
            ...
            if ((isset($params['command']) && ($params['command'] == 'Mute') && $preset['mute']) ||
                ...
                if (!isset($node['node_name']) && isset($output['type']) && ($output['type'] != 'ALSA') && ($output['type'] != 'PipeWire') && isset($params['selected']) && $params['selected'] && isset($output['selected']) && !$output['selected']) {
