...
class Handler(Flask):
    ...
    def __get_cards__(self):
        ...
        for i in system_cards:
            ...
            card_detail = Popen(["amixer", "-c", card_number, "info"], stdout=PIPE).communicate()[0].decode("utf-8")
            ...
            if len(cards[card_number]) <= 10 or ("hdmi" in card_detail and "vc4" in card_detail):
