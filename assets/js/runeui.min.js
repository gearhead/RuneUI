...
function setPlaybackSource(){if(typeof GUI.libraryhome.ActivePlayer!='undefined'){var activePlayer=GUI.libraryhome.ActivePlayer;$('#overlay-playsource-open button').text(activePlayer);$('#overlay-playsource a').addClass('inactive');var source=activePlayer.toLowerCase();$('#playsource-'+source).removeClass('inactive');}
setUIbuttons(activePlayer);$('#playlist-entries').removeClass(function(index,css){return(css.match(/(^|\s)playlist-\S+/g)||[]).join(' ');}).addClass('playlist-'+source);$('#pl-manage').removeClass(function(index,css){return(css.match(/(^|\s)pl-manage-\S+/g)||[]).join(' ');}).addClass('pl-manage-'+source);}
...
if($('#section-index').length){document.getElementById('volume').readOnly=true;if((activePlayer==='Airplay')||(activePlayer==='SpotifyConnect')||(activePlayer==='Bluetooth')){$('#volume-knob').addClass('disabled');$('#volume-knob').addClass('nomixer');$('#volume-knob button').prop('disabled',true);$('#volume').addClass('disabled');$('#volume-knob').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volume').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volumedn').addClass('disabled');$('#volumemute').addClass('disabled');$('#volumeup').addClass('disabled');$('#repeat').addClass('hide');$('#random').addClass('hide');$('#single').addClass('hide');}else{if(GUI.stream){$('#repeat').addClass('hide');$('#random').addClass('hide');$('#single').addClass('hide');}else{$('#repeat').removeClass('hide');$('#random').removeClass('hide');$('#single').removeClass('hide');}
if(typeof GUI.json.volume==='undefined'){$('#volume-knob').addClass('disabled');$('#volume-knob').addClass('nomixer');$('#volume-knob button').prop('disabled',true);$('#volume').addClass('disabled');$('#volume-knob').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volume').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volumedn').addClass('hide');$('#volumemute').addClass('hide');$('#volumeup').addClass('hide');}else{$('#volume-knob').removeClass('disabled');$('#volume-knob').removeClass('nomixer');$('#volume-knob button').prop('disabled',false);$('#volume').removeClass('disabled');$('#volume-knob').trigger('configure',{'readOnly':false,'fgColor':'#0095D8'}).css({'color':'#0095D8','pointer-events':'auto'});$('#volume').trigger('configure',{'readOnly':false,'fgColor':'#0095D8'}).css({'color':'#0095D8','pointer-events':'auto'});$('#volumedn').removeClass('hide');$('#volumemute').removeClass('hide');$('#volumeup').removeClass('hide');$('#volumedn').removeClass('disabled');$('#volumemute').removeClass('disabled');$('#volumeup').removeClass('disabled');}
$('#stop').removeClass('disabled');$('#play').removeClass('disabled');$('#next').removeClass('disabled');}}else{GUI.activePlayer='';}}
...
function updateGUI(){if((typeof GUI.json.state==='undefined')||(GUI.json.state==='')){GUI.json.state='stop';GUI.json.song_percent=0;GUI.json.elapsed=0;GUI.mainArtURL='';}
if(GUI.state!==GUI.json.state){GUI.state=GUI.json.state;if(typeof GUI.json.actPlayer!=='undefined'){setUIbuttons(GUI.json.actPlayer)}}
...
function renderUI(text){toggleLoader('close');GUI.json=text[0];updateGUI();console.log('$(#section-index).length = ',$('#section-index').length);if($('#section-index').length){if((GUI.state!=='stop')&&(GUI.json.elapsed!=='undefined')&&(typeof GUI.json.song_percent!=='undefined')){refreshKnob();}
...
if((typeof GUI.libraryhome.CDinput!=='undefined')&&(typeof GUI.libraryhome.CDinput.status!=='undefined')&&Object.keys(GUI.libraryhome.CDinput.status).length){$('#eject').removeClass('hide');$('#eject').removeClass('disabled');}else{$('#eject').addClass('hide');}}
function renderModal(text){toggleLoader('close');if((typeof isLocalHost==="undefined")||!isLocalHost){var modal=text[0];$('#'+modal.id).on('hidden.bs.modal',function(){$(this).find('input').val('');});$('#'+modal.id).modal();}}
