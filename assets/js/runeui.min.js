...
return songpath;}
var idleTime=0;var viewScreenSaver=0;var widthScreenSaver=0;var isLocalHost=0;var SStime=-1;$(document).ready(function(){GUI.clientUUID=generateUUID();if($('#section-index').length){if(location.hostname==="localhost"||location.hostname==="127.0.0.1"||location.hostname==='::1'){isLocalHost=1;SStime=localSStime;}else{isLocalHost=0;SStime=remoteSStime;}
...
function renderLibraryHome(){loadingSpinner('db');$('#database-entries').addClass('hide');$('#db-level-up').addClass('hide');$('#db-homeSetup').removeClass('hide').removeClass('btn-primary').addClass('btn-default');$('#home-blocks').removeClass('hide');var obj=GUI.libraryhome,i=0,content='',divOpen='<div class="col-lg-3 col-md-4 col-sm-6">',divClose='</div>',toggleMPD='',notMPD=((obj.ActivePlayer==='Airplay')||(obj.ActivePlayer==='SpotifyConnect')||(obj.ActivePlayer==='Bluetooth'));if(isLocalHost){content='';}else{content='<div class="col-sm-12"><h1 class="txtmid">Browse your library</h1></div>';}
...
var state=GUI.state;if(state==='play'){$('#play').addClass('btn-primary');$('i','#play').removeClass('fa fa-pause').addClass('fa fa-play');$('#stop').removeClass('btn-primary');}else if(state==='pause'){$('#playlist-position span').html('Not playing');$('#playlist-position-ss span').html('Not playing');$('#playlist-position-sss span').html('Not playing');$('#play').addClass('btn-primary');$('i','#play').removeClass('fa fa-play').addClass('fa fa-pause');$('#stop').removeClass('btn-primary');}else if(state==='stop'){$('#play').removeClass('btn-primary');$('i','#play').removeClass('fa fa-pause').addClass('fa fa-play');$('#stop').addClass('btn-primary');if($('#section-index').length){$('#countdown-display').countdown('destroy');$('#countdown-display-ss').countdown('destroy');$('#countdown-display-sss').countdown('destroy');}
...
refreshState();if($('#section-index').length){if((mainArtURL!=='')&&(GUI.mainArtURL===mainArtURL)&&!$('#cover-art').css('background-image').includes(mainArtURL)){GUI.currentartist='';GUI.currentsong='';GUI.currentalbum=''
...
$('#pl-filter-results').addClass('hide').html('');$('#pl-filter').val('');$('#pl-manage').removeClass('hide');$('#pl-count').removeClass('hide').html(pos+((pos!==1)?' entries':' entry')+' '+timeConvert3(playlisttime)+' playtime');}
...
function renderUI(text){toggleLoader('close');GUI.json=text[0];updateGUI();if($('#section-index').length){if((GUI.state!=='stop')&&(GUI.json.elapsed!=='undefined')&&(typeof GUI.json.song_percent!=='undefined')){refreshKnob();}
