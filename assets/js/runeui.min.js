...
refreshTimer(0,0,'stop');window.clearInterval(GUI.currentKnob);if((typeof GUI.stream!='undefined')&&GUI.stream){$('#total').html('<span>&infin;</span>');$('#total-ss').html('<span>&infin;</span>');$('#total-sss').html('<span>&infin;</span>');}else{$('#total').html('00:00');$('#total-ss').html('00:00');$('#total-sss').html('00:00');}
...
if(GUI.json.playlistlength&&GUI.json.playlistlength!=='0'){if((GUI.activePlayer!==undefined)&&(GUI.activePlayer!='MPD')){$('#playlist-position span').html('Streaming');$('#playlist-position-ss span').html('Streaming');$('#playlist-position-sss span').html('Streaming');}else if(GUI.json.song){$('#playlist-position span').html('Queue position '+(parseInt(GUI.json.song)+1)+'/'+GUI.json.playlistlength);$('#playlist-position-ss span').html('Queue position '+(parseInt(GUI.json.song)+1)+'/'+GUI.json.playlistlength);$('#playlist-position-sss span').html('Queue position '+(parseInt(GUI.json.song)+1)+'/'+GUI.json.playlistlength);}else{$('#playlist-position span').html('Queue position 1/'+GUI.json.playlistlength);$('#playlist-position-ss span').html('Queue position 1/'+GUI.json.playlistlength);$('#playlist-position-sss span').html('Queue position 1/'+GUI.json.playlistlength);}}else{$('#playlist-position span').html('Empty queue, add some music!');$('#playlist-position-ss span').html('Empty queue, add some music!');$('#playlist-position-sss span').html('Empty queue, add some music!');}}
...
if((local_volume_control==='0')||(local_volume_control===0)){GUI.local_volume_control='0';if(activePlayer==='MPD'){volume=100;}}else if((local_volume_control==='1')||(local_volume_control===1)){GUI.local_volume_control='1';}
