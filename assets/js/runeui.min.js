...
refreshTimer(0,0,'stop');window.clearInterval(GUI.currentKnob);if(GUI.stream){$('#total').html('<span>&infin;</span>');$('#total-ss').html('<span>&infin;</span>');$('#total-sss').html('<span>&infin;</span>');}else{$('#total').html('00:00');$('#total-ss').html('00:00');$('#total-sss').html('00:00');}
...
if(GUI.file!==file){GUI.file=file;countdownRestart(GUI.json.elapsed);if($('#panel-dx').hasClass('active')){var current=parseInt(GUI.json.song);customScroll('pl',current);}}
...
function renderUI(text){toggleLoader('close');GUI.json=text[0];if(typeof GUI.json.state!=='undefined'){if(GUI.state!==GUI.json.state){GUI.state=GUI.json.state;if(typeof GUI.json.actPlayer!=='undefined'){setUIbuttons(GUI.json.actPlayer)}}}
if(typeof GUI.json.time!=='undefined'){var time=GUI.json.time;}
if((typeof GUI.json.elapsed!=='undefined')&&(GUI.state!=='stop')){refreshTimer(parseInt(GUI.json.elapsed),0,GUI.state);}
updateGUI();if($('#section-index').length){if((GUI.state!=='stop')&&(GUI.json.elapsed!=='undefined')&&(typeof GUI.json.song_percent!=='undefined')){refreshKnob();}
