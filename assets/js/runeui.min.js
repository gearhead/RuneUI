...
function setUIbuttons(activePlayer){if((activePlayer==='Spotify')||(activePlayer==='Airplay')||(activePlayer==='SpotifyConnect')||(activePlayer==='Bluetooth')){$('#stop').addClass('disabled');$('#play').addClass('disabled');$('#next').addClass('hide');$('#previous').addClass('hide');}else{$('#stop').removeClass('disabled');$('#play').removeClass('disabled');if(GUI.state=='stop'){$('#previous').addClass('hide');$('#next').addClass('hide');}else{if((GUI.consume==='1')){$('#previous').addClass('hide');$('#next').removeClass('hide');}else{$('#previous').removeClass('hide');$('#next').removeClass('hide');}}}
if($('#section-index').length){document.getElementById('volume').readOnly=true;if((activePlayer==='Spotify')||(activePlayer==='Airplay')||(activePlayer==='SpotifyConnect')||(activePlayer==='Bluetooth')){$('#volume-knob').addClass('disabled');$('#volume-knob').addClass('nomixer');$('#volume-knob button').prop('disabled',true);$('#volume').addClass('disabled');$('#volume-knob').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volume').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volumedn').addClass('disabled');$('#volumemute').addClass('disabled');$('#volumeup').addClass('disabled');$('#repeat').addClass('hide');$('#random').addClass('hide');$('#single').addClass('hide');}else{if(GUI.stream){$('#repeat').addClass('hide');$('#random').addClass('hide');$('#single').addClass('hide');}else{$('#repeat').removeClass('hide');$('#random').removeClass('hide');$('#single').removeClass('hide');}
if(typeof GUI.json.volume==='undefined'){$('#volume-knob').addClass('disabled');$('#volume-knob').addClass('nomixer');$('#volume-knob button').prop('disabled',true);$('#volume').addClass('disabled');$('#volume-knob').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volume').trigger('configure',{'readOnly':true,'fgColor':'#1A242F'}).css({'color':'#1A242F','pointer-events':'none'});$('#volumedn').addClass('hide');$('#volumemute').addClass('hide');$('#volumeup').addClass('hide');}else{$('#volume-knob').removeClass('disabled');$('#volume-knob').removeClass('nomixer');$('#volume-knob button').prop('disabled',false);$('#volume').removeClass('disabled');$('#volume-knob').trigger('configure',{'readOnly':false,'fgColor':'#0095D8'}).css({'color':'#0095D8','pointer-events':'auto'});$('#volume').trigger('configure',{'readOnly':false,'fgColor':'#0095D8'}).css({'color':'#0095D8','pointer-events':'auto'});$('#volumedn').removeClass('hide');$('#volumemute').removeClass('hide');$('#volumeup').removeClass('hide');}
...
else if('Id'===infos[0]){songid=infos[1];if(title===''){filename=str.split('/').pop();title=filename;}
...
bottomline='URL: '+str;totaltime='';}else{totaltime='<span>'+timeConvert2(time)+'</span>';playlisttime+=time;}
...
return content;}
function populateDB(options){var data=options.data||'',path=options.path||'',uplevel=options.uplevel||0,keyword=options.keyword||'',plugin=options.plugin||'',querytype=options.querytype||'',args=options.args||'',content='',i=0,row=[];if(plugin!==''){if(plugin==='Spotify'){$('#database-entries').removeClass('hide');$('#db-level-up').removeClass('hide');$('#home-blocks').addClass('hide');if(path){GUI.currentpath=path;}
...
$(window).ready(function(){updateGUI();});$('.btn-cmd').click(function(){var el=$(this);commandButton(el);});var intervalId;var interval;$("#volumedn").on('mouseleave mouseout mouseup',function(){clearInterval(intervalId);return false;});$('#volumedn').mousedown(function(){interval=300;intervalId=setInterval(vol_down_interval,interval+200);return false;});function vol_down_interval(){clearInterval(intervalId);interval=interval-10;if(interval<50){interval=50;}
