 ...
 *
 *  file: command/wrk_spotifyd_async.php
 *  version: 0.6
 *  coder: janui
 *  date: March 2023
 */
// common include
ini_set('error_log', '/var/log/runeaudio/wrk_spotifyd_async.log');
...
// reset logfile
sysCmd('echo "--------------- start: wrk_spotifyd_async.php ---------------" > /var/log/runeaudio/wrk_spotifyd_async.log');
runelog('WORKER wrk_spotifyd_async.php STARTING...');

wrk_spotifyd($redis);

runelog('WORKER wrk_spotifyd_async.php END...');
#---
#End script
