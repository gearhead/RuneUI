 ...
 *
 *  file: command/configure_weston_ini.php
 *  version: 0.6
 *  coder: janui
 *  date: July 2023
 */
// common include
ini_set('error_log', '/var/log/runeaudio/configure_weston_ini.log');
...
// reset logfile
sysCmd('echo "--------------- start: configure_weston_ini.php ---------------" > /var/log/runeaudio/configure_weston_ini.log');
runelog('WORKER configure_weston_ini.php STARTING...');

wrk_localBrowser($redis, 'configure_weston_ini');
runelog('WORKER configure_weston_ini.php END...');
